  ...
  return (
    <main className="relative min-h-screen overflow-hidden text-black">
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <div className="grid grid-cols-2 gap-y-12 gap-x-6 max-w-4xl">
          ...
          <div className="group w-[280px] h-[380px] relative overflow-hidden">
            <Image src="/people/budi.png" alt="Person 1" fill className="object-cover" priority />
      ...
      */}
          ...
          {/* Top Right */}
          <div className="group w-[280px] h-[380px] relative overflow-hidden">
            <Image src="/people/budi.png" alt="Person 2" fill className="object-cover" priority />
            <div className="absolute inset-0 flex flex-col justify-end bg-black/60 p-4 opacity-0 translate-y-4 transition-all duration-300 group-hover:opacity-100 group-hover:translate-y-0 text-center">
          ...
          {/* Bottom Left */}
          <div className="group w-[280px] h-[380px] relative overflow-hidden">
            <Image src="/people/budi.png" alt="Person 3" fill className="object-cover" priority />
            <div className="absolute inset-0 flex flex-col justify-end bg-black/60 p-4 opacity-0 translate-y-4 transition-all duration-300 group-hover:opacity-100 group-hover:translate-y-0 text-center">
          ...
          {/* Bottom Right */}
          <div className="group w-[280px] h-[380px] relative overflow-hidden">
            <Image src="/people/budi.png" alt="Person 4" fill className="object-cover" priority />
            <div className="absolute inset-0 flex flex-col justify-end bg-black/60 p-4 opacity-0 translate-y-4 transition-all duration-300 group-hover:opacity-100 group-hover:translate-y-0 text-center">
