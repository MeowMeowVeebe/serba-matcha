...
export default function EnhancedDemoPage() {
  ...
  const commands: CommandItem[] = [
    { id: "dashboard", label: "Go to Dashboard", icon: "📊", category: "navigation", action: () => window.location.href = "/dashboard/home", keywords: ["home", "main"] },
    { id: "settings", label: "Open Settings", icon: "⚙️", category: "navigation", action: () => window.location.href = "/dashboard/settings", keywords: ["config", "preferences"] },
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "1rem" }}>
          <InteractiveCard variant="glass" hoverEffect="all">
            ...
            <p style={{ color: "var(--color-text-muted)", fontSize: "0.875rem" }}>
              Hover to see smooth glow and 3D tilt effects
            </p>
          </InteractiveCard>
          <InteractiveCard 
            variant="elevated" 
