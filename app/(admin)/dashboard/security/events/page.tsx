...
export default function SecurityEventsPage() {
  ...
  return (
    <AccountShell
      ...
      breadcrumbs={[{ label: "Security", href: "/dashboard/security" }, { label: "Events", href: "/dashboard/security/events" }]}
    >
            ...
            {isLoadingUser || isLoading ? (
              ...
              <>
                ...
                <div className={styles.actions}>
                  <Link className="secondary-btn" href="/dashboard/security/sessions">Sessions</Link>
                  <Link className="secondary-btn" href="/dashboard/admin/audit-logs">Audit Logs</Link>
                </div>
              </>
            )}
          </div>
