          ...
          <div className="success-hub">
            {isLoadingUser || isLoading ? (
              ...
              <div className={styles.emptyState}>
                ...
                <p>{loadError ?? "Please sign in to access Customer Success Hub."}</p>
              ...
              <>
                ...
                <div className="success-hub__status">
                  <div>
                    ...
                    <p>{statusSummary || "No status data."}</p>
                  </div>
                  <button className="secondary-btn" type="button">Open accounts</button>
                </div>

                <SectionFeedback prompt="Does customer success hub help monitor customer health?" />
              </>
            )}
          </div>
        );
