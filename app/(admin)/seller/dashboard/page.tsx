    ...
    <AccountShell
      ...
      actions={
        <div className="flex flex-wrap gap-2">
          <Link className="matcha-btn matcha-btn--secondary" href="/seller/products">
            Kelola Produk
          </Link>
      ...
      <div className="sd-card">
        ...
        <div className="sd-card__body">
          <div className="sd-actions">
            <Link className="sd-action" href="/seller/products">
          ...
          <div className="sd-actions__cta">
            <Link className="sd-btn sd-btn--primary" href="/seller/products">
              + Tambah Produk
            </Link>
