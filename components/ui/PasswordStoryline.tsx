...
const hints = {
  weak: "Gunakan 8+ karakter dan kombinasi huruf/angka.",
  fair: "Tambahkan simbol atau variasi huruf besar-kecil.",
  good: "Pertahankan kombinasi dan tambah panjang jika perlu.",
  strong: "Password sudah kuat, simpan dengan aman.",
};
